        ...
        <div>
            ...
            <div className="flex justify-center pt-8">
                <div className="w-[95%] md:w-[80%] flex grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                    <a className="xl:hover:opacity-[60%] xl:duration-200" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=7XWS4yVYFZE"><img src="/miniatures/minia_8.jpg" alt="demo"></img></a>
