...
const Navbar = () => {
  ...
  return (
    <div className="font-m_poppins flex flex-row text-xl items-center justify-between lg:justify-normal">
      <div className="ml-4 lg:ml-8">
        <Logo mw={16} mh={16} />
      </div>
      <div className="lg:hidden flex flex-col items-center justify-center text-white">
        <p className="font-poppins text-base">Mathis Lunot</p>
        <p className="font-m_poppins text-base">Cinematographer</p>
      </div>
      <div className={`hidden lg:inline space-x-8 text-xl text-white lg:ml-[14%] ${showMenu ? "hidden" : "block"}`}>
